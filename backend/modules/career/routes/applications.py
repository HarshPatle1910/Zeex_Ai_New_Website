...
# Ensure backend root is in path for config import
backend_root = Path(__file__).parent.parent.parent
if str(backend_root) not in sys.path:
    sys.path.insert(0, str(backend_root))

from modules.career.models import db, JobApplication
from modules.career.services.validation_service import ValidationService
...
def get_all_applications():
    ...
    GET /api/applications/check-data
